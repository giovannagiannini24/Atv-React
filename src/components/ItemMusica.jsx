...
const estiloCard ={
backgroundImage: `url(${
    props.capa ? props.capa : capaPadrao
})`
...
<div className="card-music" style={estiloCard}>
                ...
                <div className="info-music">
                    <p>
                        ...
                        <input className="input-music-disabled" type="text" value={props.nome} />
                    </p>
                    <p>
                    ...
                    <p>
                        <strong className="card-title">genero: </strong>
                        <input className="input-music-disabled" type="text" value={props.genero} />
                    </p>
                    <p>
                        <strong className="card-title">ano: </strong>
                        <input className="input-music-disabled" type="text" value={props.ano} />
                    </p>
